...
export class ERC20OrderRouter extends ethereum.SmartContract {
  static bind(address: Address): ERC20OrderRouter {
    return new ERC20OrderRouter("ERC20OrderRouter", address);
  }

  gelatoPineCore(): Address {
    let result = super.call("gelatoPineCore", "gelatoPineCore():(address)", []);

    return result[0].toAddress();
  }

  try_gelatoPineCore(): ethereum.CallResult<Address> {
